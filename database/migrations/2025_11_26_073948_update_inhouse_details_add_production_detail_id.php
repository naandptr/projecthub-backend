...
return new class extends Migration
{
    ...
    {
        Schema::table('inhouse_details', function (Blueprint $table) {
            try {
                $table->dropForeign(['production_id']);
            } catch (\Exception $e) {
            }

            if (Schema::hasColumn('inhouse_details', 'production_id')) {
    ...
    public function down(): void
    {
        ...
        Schema::table('inhouse_details', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('inhouse_details', 'production_detail_id')) {
